...
$python_exe benchmark.py --dataset bio-diseasome --type DP --proba_params  0 0 1 --n_experiments 1
$python_exe benchmark.py --dataset bio-diseasome --type DP --proba_params  0.05 0.05 0.9 --n_experiments 1
$python_exe benchmark.py --dataset bio-diseasome --type DP --proba_params  0.125 0.125 0.75 --n_experiments 1
$python_exe benchmark.py --dataset bio-diseasome --type DP --proba_params  0.25 0.25 0.5 --n_experiments 1
$python_exe benchmark.py --dataset bio-diseasome --type DP --proba_params  0.75 0.125 0.125 --n_experiments 1
...
$python_exe benchmark.py --dataset bio-diseasome --type DPD --proba_params  0 0 1 --n_experiments 1
$python_exe benchmark.py --dataset bio-diseasome --type DPD --proba_params  0.05 0.05 0.9 --n_experiments 1
$python_exe benchmark.py --dataset bio-diseasome --type DPD --proba_params  0.125 0.125 0.75 --n_experiments 1
$python_exe benchmark.py --dataset bio-diseasome --type DPD --proba_params  0.25 0.25 0.5 --n_experiments 1
$python_exe benchmark.py --dataset bio-diseasome --type DPD --proba_params  0.75 0.125 0.125 --n_experiments 1
